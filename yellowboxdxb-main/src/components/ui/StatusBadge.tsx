...
export const TestStatusBadge = memo(function TestStatusBadge({ status, className }: TestStatusBadgeProps) {
  return (
    <div
      className={cn(
...
export const StageBadge = memo(function StageBadge({ stage, className, size = "default" }: StageBadgeProps) {
