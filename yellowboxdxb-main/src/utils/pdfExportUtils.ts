 ...
 */
export const exportMonthlyExpensePDF = async (
  expenses: SpendEvent[],
 ...
 */
export const exportRiderExpensePDF = async (rider: Rider, expenses: SpendEvent[]) => {
  const jsPDF = await loadJsPDF();
  const doc = new jsPDF();
 ...
 */
export const exportBudgetAnalysisPDF = async (
  budgets: Budget[],
  expenses: SpendEvent[],
  startDate: Date,
  endDate: Date
 ...
 */
export const exportFinancialSummaryPDF = async (
  expenses: SpendEvent[],
  budgets: Budget[],
  riders: Rider[]
) => {
